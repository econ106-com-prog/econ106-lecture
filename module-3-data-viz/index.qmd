...
title-slide-attributes: 
  data-background-image: "img/data-viz-ggplot.png"
...
## working directory
setwd(here::here("module-3-data-viz"))
...
::: {.column width="40%"}
Visualize the distribution of sepal lengths across species using a beeswarm plot.
...
- Plot Sepal.Length (y-axis) against Species (x-axis).
- Use geom_beeswarm() to spread points and avoid overlap.
- Color points by species for clarity.
:::
...
# Beeswarm plot: Sepal length by species
ggplot(iris, aes(x = Species, y = Sepal.Length, color = Species)) +
  ...
  theme(
    ...
    axis.title = element_text(size = 14, margin = margin(r = 20, t = 20)),
    legend.text = element_text(size = 14),
    legend.title = element_text(size = 16)
  )

ggsave(filename = "img/scatter_sample.jpg",
       width = 8, heigh = 6)
```
...
knitr::include_graphics("img/scatter_sample.jpg")
```
:::
:::
<!-- end columns -->
...
knitr::include_graphics("img/econ106-logo.png")
```